    ...
    const html = `
      <div style="font-family: 'Georgia', serif; max-width: 600px; margin: 0 auto; background: #F7F3EE;">
        <div style="background: #2A2520; padding: 28px 32px; border-left: 4px solid #B8963E;">
          <h1 style="color: #F7F3EE; margin: 0; font-size: 22px; font-weight: 400; letter-spacing: 0.05em;">Elegant Interiors</h1>
        ...
        <div style="background: #FDFAF6; padding: 32px; border: 1px solid #E8E0D5; border-top: none;">
          ...
          <p style="color: #4A4540; font-size: 14px; line-height: 1.6; margin: 0 0 32px;">Thank you for the privilege of designing your space.</p>
          <p style="color: #8A8278; font-size: 11px; font-family: monospace; letter-spacing: 0.08em; margin: 0; padding-top: 16px; border-top: 1px solid #E8E0D5;">Elegant Interiors · Studio OS</p>
        </div>
      </div>
    `
...
function InvoicePanel({ invoices, payments, projects, clients, items, reload }) {
  const [expandedInvoice, setExpandedInvoice] = useState(null)
  ...
  function generatePanelPDF(invoice) {
    ...
    const client = clients.find(c => c.id === invoice.client_id)
    const project = projects.find(p => p.id === invoice.project_id)
    const brand = { name:'Elegant Interiors', tagline:'Interior Design Studio', website:'www.elegantinteriors.com', email:'studio@elegantinteriors.com', phone:'(212) 555-0199', thankYou:'Thank you for the privilege of designing your space.' }
